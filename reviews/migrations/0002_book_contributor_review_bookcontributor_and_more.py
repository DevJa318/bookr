...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('AUTHOR', 'Author'), ('CO_AUTHORCo-Author', 'Co Author'), ('EDITOR', 'Editor')], max_length=20, verbose_name='Rola jaką współtwórca odegrał przy tworzeniu tej książki')),
